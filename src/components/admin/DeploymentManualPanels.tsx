      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="overview">
          ...
          <AccordionContent className="space-y-2 text-sm">
            <p>This is a learning platform for Intelligent Devices. Users browse topic sets, revise with flashcards, mark mastery, and bookmark content for learning and mastery.</p>
